...
export class ShowResults extends Component {
    ...
    _setPersonalDataFields(data) {
        ...
        this.setState({
            country, inputCheckbox, uidNumberField,
                        ...
                        <ul>
                            {userAnswers[answer].map((item, i) => {
                                    return (<li key={i}>
                                        ...
                                        {!item.hasOwnProperty('colorCode') && answer !== 'Model' && item.image &&
                                        <img src={item.image}/>}
                                        {item.colorCode &&
                                        <span className="colorPic" style={{backgroundColor: item.colorCode}}/>}
                                    </li>)
                                }
                            )
                            }
                ...
                elementsArray.push(
                    <div className={className} key={answer}>
                        ...
                        <p>{userAnswers[answer].map((item, i) =>
                            <span
                                key={i}>{item['description-short']}{i < userAnswers[answer].length - 1 ? ', ' : null}</span>)}
                        </p>
                    </div>
                )
            }
    ...
    render() {
        ...
        let {userAnswers, changeComment, closeShowResults, user} = this.props,
            {country, inputCheckbox, errors, currentTab, coupon, summaryTabContent, uidNumberField, place, defineTypeElem, showLoginForm} = this.state,
            price = 0,
                                        ...
                                        <div className="clearfix">
                                            ...
                                            <div className={summaryTabContent !== 'chooseLocation' ? "col-sm-8" : "col-md-12"}>
                                                <div className="row">
                                                    ...
                                                    {summaryTabContent === 'bringToShop' && <BringToShop place={place}/>}
