...
import ChooseLocation from "./summaryTabContent/chooseLocation"
...
export class ShowResults extends Component {
    ...
    changeSummaryTabContent(value, place) {
        ...
        if (value == 'chooseLocation' && window.isDesktop) {
    ...
    render() {
        ...
        return (
            <div className={!window.isDesktop ? "resultSellPage for-mobile" : "resultSellPage"}>
                {summaryTabContent === 'chooseLocation' && window.isDesktop &&
                    <div className="cover" />
                }
                <div className={summaryTabContent === 'chooseLocation' && window.isDesktop ? "tabs blurred" : summaryTabContent === 'chooseLocation' ? "hide" : "tabs"}>
                        ...
                        <ul className="nav nav-pills nav-justified" role="tablist">
                            <li role="presentation" className={currentTab === 'summary' ? "active" : null}>
                                <a href="#summary" aria-controls="home" role="tab">
                                    ...
                                    <span className="step-name">Zusammenfassung</span>
                                </a>
                            </li>
                            {!window.isDesktop &&
                            ...
                            <li role="presentation" className={currentTab === 'form' ? "active" : null}>
                                <a href="#form" aria-controls="profile" role="tab">
                                    ...
                                    <span className="step-name">Persönliche Angaben</span>
                                </a>
                            </li>
                            {!window.isDesktop &&
                            <li role="presentation" className={currentTab === 'form' || currentTab === 'instructions' ? "active" : null}>
                                <div className="separator"></div> 
                            </li>
                            }
                            <li role="presentation" className={currentTab === 'instructions' ? "active" : null}>
                                <a href="#instructions" aria-controls="messages" role="tab">
                                    ...
                                    <span className="step-name">Anleitung</span>
                                </a>
                            </li>
                        </ul>
                        {window.isDesktop && (
                    ...
                    <div className="tab-content">
                        {userAnswers &&
                        <div role="tabpanel" className={currentTab === 'summary' ? "tab-pane active" : "tab-pane"}  id="summary">
                            <div className="clearfix">
                                <BringToShop
                                    place={place && Object.keys(place).length !== 0 ? place : places.data[0]}
                                    userAnswers={userAnswers}
                                    storageSellDeadline={storageSellDeadline}
                                    price={price}
                                    coupon={coupon}
                                    sellDeadlineExpired={sellDeadlineExpired}
                                    changeSummaryTabContent={this.changeSummaryTabContent}
                                    handleClickMobileBtn={this.handleClickMobileBtn}
                                    setStep={this.props.setStep}
                                    setCurrentTabFrom = {() => this.setState({currentTab: 'form'})}
                                    saveAndBackToSellProcess={this.saveAndBackToSellProcess}
                    ...
                    {!window.isDesktop && (
                        <div className="tab-menu-bottom">
                            {(userAnswers && ((currentTab === 'summary' && summaryTabContent !== 'chooseLocation') || currentTab === 'form' || currentTab === 'instructions') ) && <SendLinks user={user} id={currentTab} />}
                        </div>
                    )}
                </div>
                {summaryTabContent === 'chooseLocation' &&
                    <ChooseLocation places={places} changeSummaryTabContent={this.changeSummaryTabContent}/>
                }
